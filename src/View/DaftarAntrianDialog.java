...
public final class DaftarAntrianDialog extends JDialog implements ActionListener {
    ...
    private JLabel pemisah1, pemisah2;
    private JTextField namaText;
    private JTextField noRMText;
    private JTextField alamatText;
    private JTextField tanggalLahirText;
    private JTextField bulanLahirText;
    private JTextField tahunLahirText;
    ...
    public void init() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (test == null) {
                    ...
                    try {
                        ...
                        tanggalLahirText.setText(tanggal);
                        bulanLahirText.setText(bulan);
                        tahunLahirText.setText(tahun);
        ...
        tanggalLahirText = new JTextField(100);
        tanggalLahirText.setBounds(150, 140, 100, 20);
        this.add(tanggalLahirText);

        //pemisah 1 dan 2
        pemisah1 = new JLabel("/");
        pemisah1.setFont(new Font("Courier New", Font.BOLD, 22));
        pemisah1.setBounds(255, 126, 50, 50);
        this.add(pemisah1);

        pemisah2 = new JLabel("/");
        pemisah2.setFont(new Font("Courier New", Font.BOLD, 22));
        pemisah2.setBounds(383, 126, 50, 50);
        this.add(pemisah2);

        //bulan lahir
        bulanLahirText = new JTextField(100);
        bulanLahirText.setBounds(275, 140, 100, 20);
        this.add(bulanLahirText);

        //tahunLahir
        tahunLahirText = new JTextField(100);
        tahunLahirText.setBounds(400, 140, 100, 20);
        this.add(tahunLahirText);
            ...
            for (int i = 0; i < Pasien.daftarPasien.size(); i++) {
                if (test == Pasien.daftarPasien.get(i)) {
                    try {
                        ...
                        int tanggal = Integer.parseInt(tanggalLahirText.getText());
                        int bulan = Integer.parseInt(bulanLahirText.getText());
                        int tahun = Integer.parseInt(tahunLahirText.getText());
