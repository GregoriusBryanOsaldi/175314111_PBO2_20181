...
public class DaftarPasienBaru extends JFrame {
    ...
    public void init() {
        ...
        namaText.setBounds(150, 50, 350, 20);
        this.add(namaText);
        ...
        alamatText.setBounds(150, 80, 350, 20);
        this.add(alamatText);
        ...
        bulanButton.setBounds(255, 110, 100, 20);
        this.add(bulanButton);

        //Tahun Lahir
        this.setLayout(null);
        tahunLahir = new JLabel("Tahun");
        tahunLahir.setBounds(360, 110, 100, 15);
        this.add(tahunLahir);
        ...
        tahunButton.setBounds(400, 110, 100, 20);
        this.add(tahunButton);

        //Tombol Simpan
        saveButton = new JButton("Simpan");
        saveButton.setBounds(240, 160, 80, 30);
        this.add(saveButton);
    }
}
